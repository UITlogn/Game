...
CARHEIGHT = 60
CARSPEED = 3
CARIMG = pygame.image.load(LINK+'\\VScode\\PYTHON_3\\Game\\LaiXe\\xexanh.png')

DISTANCE = 200
OBSTACLESSPEED = 2
CHANGESPEED = 0.001
OBSTACLESIMG = pygame.image.load(LINK+'\\VScode\\PYTHON_3\\Game\\LaiXe\\xedo.png')

BGSPEED = 1.5
BGIMG = pygame.image.load(LINK+'\\VScode\\PYTHON_3\\Game\\LaiXe\\background.png')
...
def gameStart(bg):
    ...
    commentSuface = font.render('Nhan "space" de choi', True, (0, 0, 0))
