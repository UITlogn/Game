...
G = 0.5
SPEEDFLY = -8
BIRDIMG = pygame.image.load(LINK+'\\VScode\\PYTHON_3\\Game\\FlappyBird\\bird.png')
...
DISTANCE = 300
COLUMNSPEED = 2
COLUMNIMG = pygame.image.load(LINK+'\\VScode\\PYTHON_3\\Game\\FlappyBird\\column.png')

BACKGROUND = pygame.image.load(LINK+'\\VScode\\PYTHON_3\\Game\\FlappyBird\\background.png')
...
def gameStart(bird):
    ...
    commentSuface = font.render('Click or press a key to start', True, (0, 0, 0))
